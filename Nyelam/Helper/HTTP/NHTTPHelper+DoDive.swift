...
extension NHTTPHelper {
    ...
    static func httpDoDiveSearchBy(categories: [String], page: String, diver: Int, certificate: Int, date: TimeInterval, sortBy: Int, ecoTrip: Int?, totalDives: [String]?, facilities: [String]?, complete: @escaping (NHTTPResponse<[NDiveService]>)->()) {
        var param: [String: Any] = [:]
        param["page"] = page
    ...
    static func httpDoDiveSearchBy(diveSpotId: String, page: String, diver: Int, certificate: Int, date: TimeInterval, sortBy: Int, ecoTrip: Int?, totalDives: [String]?, categories: [String]?, facilities: [String]?, complete: @escaping (NHTTPResponse<[NDiveService]>)->()) {
        var param: [String: Any] = [:]
        param["page"] = page
        param["diver"] = String(diver)
        param["license"] = String(certificate)
    ...
    static func httpDoDiveSearchBy(provinceId: String, page: String, diver: Int, certificate: Int, date: TimeInterval, sortBy: Int, ecoTrip: Int?, totalDives: [String]?, categories: [String]?, facilities: [String]?, complete: @escaping (NHTTPResponse<[NDiveService]>)->()) {
        var param: [String: Any] = [:]
        param["page"] = page
        param["diver"] = String(diver)
        param["license"] = String(certificate)
    ...
    static func httpDoDiveSearchDiveServiceBy(cityId: String, page: String, diver: Int, certificate: Int, date: TimeInterval, sortBy: Int, ecoTrip: Int?, totalDives: [String]?, categories: [String]?, facilities: [String]?, complete: @escaping (NHTTPResponse<[NDiveService]>)->()) {
        var param: [String: Any] = [:]
        param["page"] = page
        param["diver"] = String(diver)
        param["license"] = String(certificate)
    ...
    static func httpDoDiveSearchDiveServiceBy(diveCenterId: String, page: String, diver: Int, certificate: Int, date: TimeInterval, sortBy: Int, ecoTrip: Int?, totalDives: [String]?, categories: [String]?, facilities: [String]?, complete: @escaping (NHTTPResponse<[NDiveService]>)->()) {
        var param: [String: Any] = [:]
        param["page"] = page
        param["diver"] = String(diver)
        param["license"] = String(certificate)
